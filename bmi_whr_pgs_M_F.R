...
write.csv(bmi_females_renamed, file = "bmi_females_unclumped_pgs(n=306).csv", row.names = FALSE, quote = FALSE)
write.csv(whr_females_clumped, file = "bmi_females_clumped_pgs(n=187).csv", row.names = FALSE, quote = FALSE)
...
write.csv(bmi_males_renamed, file = "bmi_males_unclumped_pgs(n=243).csv", row.names = FALSE, quote = FALSE)
write.csv(bmi_males_clumped, file = "bmi_males_clumped_pgs(n=153).csv", row.names = FALSE, quote = FALSE)
...
write.csv(whr_females_renamed, file = "whr_females_unclumped_pgs(n=363).csv", row.names = FALSE, quote = FALSE)
write.csv(whr_females_clumped, file = "whr_females_clumped_pgs(n=192).csv", row.names = FALSE, quote = FALSE)
...
write.csv(whr_males_renamed, file = "whr_males_unclumped_pgs(n=102).csv", row.names = FALSE, quote = FALSE)
write.csv(whr_males_clumped, file = "whr_males_clumped_pgs(n=75).csv", row.names = FALSE, quote = FALSE)